...
export async function fetchLatestInvoices() {
  ...
  try {
    const data: LatestInvoiceRaw[] = await db.query<LatestInvoiceRaw>(`
...
export async function fetchInvoiceById(id: string) {
  ...
  try {
    const data: InvoiceForm[] = await db.query<InvoiceForm>(`
      SELECT
        invoices.id,
...
export async function fetchFilteredCustomers(query: string) {
  ...
  try {
    const data: CustomersTableType[] = await db.query<CustomersTableType>(`
		SELECT
		  customers.id,
		  customers.name,
		  customers.email,
